...
z_max  = Nx*dx*dx/lam
z_lens = z_max/2
f      = z_max/4                    # 2f-2f imaging: object at 0 is 2f before lens, image at z_max
width  = 6*lam                      # rect width for this case (adjust freely)
...
plt.title('Rect input, 2f-2f imaging (lens at midplane → image at z_max)')
